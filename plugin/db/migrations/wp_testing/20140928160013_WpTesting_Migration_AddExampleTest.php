...
class WpTesting_Migration_AddExampleTest extends WpTesting_Migration_UpdateData
{
    public function up()
    {
        ...
        $this->execute("
            INSERT INTO $posts (
                ...
                1, NOW(), NOW(), 'Tech4Good Template (Description)', '', 'publish', 'closed', 'closed', '', 'tech4good-template', '', '', NOW(), NOW(), '', 0, UUID(), 0, 'wpt_test', '', 0);
